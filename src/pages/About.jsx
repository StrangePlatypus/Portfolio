...
{/** SOFT SKILLS SECTION */}
                <div className={sectionStyle}>
                    ...
                    <div className={textDivStyle}>
                        <h2 className="text-xl md:text-3xl my-8 font-semibold">Soft skills et loisirs</h2>
                        <p className="text-sm md:text-lg">Souvent mises à l'écart, les passions et passes-temps sont pourtant de véritables atouts.<br/>Pour ma part, je pratique :</p>
                        <ul className="text-sm md:text-lg text-start my-6 lg:px-12 list-disc">
