...
function Home() {
  ...
  return (
    <main className='w-full h-[90vh] flex flex-wrap place-content-center-safe'>
      <BgVideo />
      <div className="home_text md:absolute w-fit md:max-w-[80vw] md:h-[30vh] md:top-[40vh] md:right-0 font-hahmlet p-8 flex flex-col items-center md:items-end justify-around gap-12 md:gap-2">
